...
# Fixar análise apenas para Golden State Warriors
st.sidebar.markdown(
...
entity_type = "Time"  # Fixado como Time
...
# Carregar automaticamente o Golden State Warriors
st.sidebar.markdown("---")

# Carregar Golden State Warriors automaticamente na primeira execução
